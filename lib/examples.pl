...
%%  currently planned by Clam version 3.2.       %%
%%  This corpus forms the basis for the          %%
%%  experiments reported in DAI Research         %%
%%  Paper 713 (JAR Vol 16: 79-111, 1996).        %%
%%  Note that certain of the sink speculation    %%
%%  examples require the extended version of     %%
%%  the wave critic (see CADE-13 & Heriot-Watt   %%
%%  Research Memo RM-97-11 for more details).    %%
%%						 %%
...
%%       speculation
%%
example(lemma,   ordsort           ,skip). % t14: fails on proof of lemma
...
example(lemma,   revqrevnil3       ,skip). % CADE-13 & RM-97-11
example(lemma,   revqrevnil4       ,skip). % CADE-13 & RM-97-11
example(lemma,   splitlist         ,skip). % CADE-13 & RM-97-11
example(lemma,   sumprod           ,skip). % CADE-13 & RM-97-11
example(lemma,   qrevapp           ,skip). % CADE-13 & RM-97-11
example(lemma,   qrevatend         ,skip). % CADE-13 & RM-97-11
